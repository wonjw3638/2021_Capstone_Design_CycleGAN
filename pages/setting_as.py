...
def asp():
  ...
  # checkpoint_path = '/content/drive/MyDrive/save_sa'  # Colab
  checkpoint_path = r'C:\Users\BTLsub\Desktop\checkpoints-002\save_sa'  # ''사이에 save_sa 압축 푼 경로 복붙
  # print('Version :', tf.train.latest_checkpoint(checkpoint_path))  # to check stored latest version.
  ...
  output = generate_images(generator_f, input_exp)    # image 변환
